drop view if exists dbo.physical_location_site__dbt_tmp_temp_view


   drop table if exists dbo.physical_location_site__dbt_tmp


   EXEC('create view dbo.physical_location_site__dbt_tmp_temp_view as
...
select * from physical_location_site
   ...
   SELECT * INTO dbo.physical_location_site__dbt_tmp FROM
    dbo.physical_location_site__dbt_tmp_temp_view

   drop view if exists dbo.physical_location_site__dbt_tmp_temp_view

    
   DROP INDEX IF EXISTS dbo_physical_location_site__dbt_tmp.dbo_physical_location_site__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_physical_location_site__dbt_tmp_cci
    ON dbo.physical_location_site__dbt_tmp
